              ...
              <div className="space-y-6">
                {relevantCertificates.map((cert, idx) => (
                  <motion.div 
                    ...
                    className="group p-5 rounded-2xl bg-white/5 border border-white/5 hover:border-brand-accent/30 hover:bg-white/10 transition-all"
                  >
                    <div className="flex justify-between items-start mb-3">
                      <h3 className="text-lg font-bold text-zinc-200 group-hover:text-brand-accent transition-colors">
                        {cert.title}
                      </h3>
                      <div className="flex gap-2">
                        {cert.pdf && (
                          <a 
                            ...
                            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-brand-accent/10 hover:bg-brand-accent/20 border border-brand-accent/20 text-brand-accent text-xs font-bold uppercase tracking-wider transition-all"
