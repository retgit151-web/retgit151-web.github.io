...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'A centralized administrative dashboard that automates the collection of critical system data, providing real-time visibility into network status, CPU load, and storage usage',
    longDescription: 'This document serves as a technical guide for the Linux Info Automation Tool. The primary function of this script is to act as a centralized "Dashboard" for system administrators, automating the collection of critical system data.',
  ...
  },
  {
    ...
    longDescription: 'This document serves as a technical guide for the Anonymous Enumeration Tool script. The primary function of this tool is to perform Nmap and Whois network scans against a user-specified IP target.',
  ...
  },
  {
    ...
    longDescription: 'This document serves as a technical guide for the Automated Security Log Parser. The primary function of this script is to perform rapid security auditing on Linux authentication logs (/var/log/auth.log).',
  ...
  },
  {
    ...
    longDescription: 'This document serves as a technical guide for the Automated Memory Analyzer. The primary function of this script is to perform automatic carving on raw memory dumps without requiring manual interaction or complex syntax memorization.',
